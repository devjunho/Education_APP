...
namespace PlantTemp.ViewModels
{
    ...
    public class QuizViewModel1 :ViewModelBase
    {
        private static QuizViewModel1 _instance;
        ...
        public static QuizViewModel1 Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new QuizViewModel1();
                }
                return _instance;
            }
        }
