...
namespace PlantTemp.ViewModels
{
    ...
    public class QuizViewModel2 :ViewModelBase
    {
        private static QuizViewModel2 _instance;
        ...
        public static QuizViewModel2 Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new QuizViewModel2();
                }
                return _instance;
            }
        }
